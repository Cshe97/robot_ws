    ...
    try:   
        while rclpy.ok():
            ...
            # [320, 240]
                ...
                ret,thresh1 = cv2.threshold(blur, 90, 255, cv2.THRESH_BINARY_INV) #명암 75 이하 255, 이상 0으로 이진화
