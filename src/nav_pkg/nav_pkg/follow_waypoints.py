...
def main(args=None):	
    ...
    rgoal2.pose.position.x = 2.68
    rgoal2.pose.position.y = -0.99
    rgoal2.pose.orientation.w = 1.0
    print(rgoal2)

    mgoal = []
    if follow_points_client.nav_msg == 'point1':
        print("point1")
        mgoal = rgoal1
    elif follow_points_client.nav_msg == 'point2':
        print("point2")
        mgoal = rgoal2
    

    #해당 지점(mgoal)으로 이동시키는 함수
